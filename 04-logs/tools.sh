...
echo "Prepare microservice..." >> "$LOGFILE" 2>&1
cd ~/killercoda-training
chmod a+x ~/killercoda-training/microservice-2/mvnw
cd ~/killercoda-training/microservice-2/
./mvnw clean install >> "$LOGFILE" 2>&1
